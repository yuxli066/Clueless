            ...
            class g extends r.BaseCommand {
              ...
              async execute() {
                ...
                const d = i ? n.topLevelWorkspace : o,
                  ...
                  y = [];
                for (const e of g)
                  (p && !e.manifest.scripts.has(p)) ||
                    (p === process.env.npm_lifecycle_event &&
                      e.cwd === o.cwd) ||
                  ...
                  async (e) => {
                    const o = async (n, { commandIndex: o }) => {
                      ...
                      try {
                        ...
                        throw (s.end(), l.end(), await i, await p, e);
                      }
                    };
              ...
              o(
                [
                  s.Command.Array("--include", {
                    description:
                      "An array of glob pattern idents that acts as a whitelist of workspaces",
                  }),
                ],
                g.prototype,
                "include",
              ...
              o(
                [
                  s.Command.Array("--exclude", {
                    description:
                      "An array of glob pattern idents that acts as a blacklist of workspaces",
                  }),
                ],
                g.prototype,
                "exclude",
              ...
              o(
                [
                  s.Command.Boolean("--private", {
                    description: "Also run the command on private workspaces",
                  }),
                ],
                g.prototype,
                "private",
            ...
            e.exports = (e, t = {}) => {
              let n = (e, a = {}) => {
                let s = r.isInvalidBrace(a),
                  ...
                  p = !0 === t.escapeInvalid ? "\\" : "",
                  u = "";
                if (!0 === e.isOpen) return p + e.value;
                if (!0 === e.isClose) return p + e.value;
                if ("open" === e.type) return l ? p + e.value : "(";
                if ("close" === e.type) return l ? p + e.value : ")";
                if ("comma" === e.type)
                ...
                if (e.nodes) for (let t of e.nodes) u += n(t, e);
                return u;
              };
              return n(e);
            };
              ...
              let n = void 0 === t.rangeLimit ? 1e3 : t.rangeLimit,
                i = (e, l = {}) => {
                  ...
                  for (; "brace" !== p.type && "root" !== p.type && p.parent; )
                    (p = p.parent), (u = p.queue);
                  if (e.invalid || e.dollar)
                    return void u.push(s(u.pop(), r(e, t)));
                  if (
                    "brace" === e.type &&
                    !0 !== e.invalid &&
                    2 === e.nodes.length
                  )
                    return void u.push(s(u.pop(), ["{}"]));
                  if (e.nodes && e.ranges > 0) {
          ...
          169: (e, t, n) => {
            ...
            const o = n(669),
              ...
              g = (e, t, n = 1, o = {}) => {
                ...
                if (o.toRegex && 1 === n) return c(u(e, y), u(t, y), !0, o);
                    ...
                    ? i(e) && i(t)
                      ...
                      : ((e, t, n = 1, o = {}) => {
                          ...
                          let r =
                            ...
                            p = Math.min(a, s),
                            u = Math.max(a, s);
                          if (o.toRegex && 1 === n) return c(p, u, !1, o);
                          let f = [],
                            g = 0;
                          for (; l ? a >= s : a <= s; )
            ...
            const o = n(669),
              ...
              l = (e, t, n) => {
                ...
                for (let s = 0; s < t.length; s++) {
                  let p = a(String(t[s]), { ...n, onResult: l }, !0),
                    u = p.state.negated || p.state.negatedExtglob;
                  u && i++;
                  for (let t of e) {
                    let e = p(t, !0);
              ...
              const b = (e) =>
                ...
                x = (e) => {
                  switch (e) {
                    ...
                    case "**/*.*":
                      return `(?:${m}${b(n)}${c})?${_}${C}${u}${d}${C}`;
                    case "**/.*":
                      return `(?:${m}${b(n)}${c})?${u}${d}${C}`;
                    default: {
                      const t = /^(.*?)\.(\w+)$/.exec(e);
                      if (!t) return;
                      const n = x(t[1]);
          ...
          828: (e, t, n) => {
            const o = n(622),
              ...
              l = (e, t, n = !1) => {
                ...
                const a = t || {},
                  i = s.isWindows(t),
                  p = o ? l.compileRe(e, t) : l.makeRe(e, t, !1, !0),
                  u = p.state;
                delete p.state;
                let c = () => !1;
                if (a.ignore) {
                ...
                const d = (n, o = !1) => {
                  const { isMatch: r, match: s, output: d } = l.test(n, p, t, {
                      glob: e,
                      posix: i,
                    }),
                    f = {
            ...
            (l.test = (e, t, n, { glob: o, posix: r } = {}) => {
                ...
                (!1 !== p && !0 !== a.capture) ||
                  (p =
                    !0 === a.matchBase || !0 === a.basename
                      ? l.matchBase(e, t, n, r)
                      : t.exec(u)),
                { isMatch: Boolean(p), match: p, output: u }
              );
            }),
              ...
              (l.compileRe = (e, t, n = !1, o = !1) => {
                ...
                let i = `${a}(?:${e.output})${s}`;
                e && !0 === e.negated && (i = `^(?!${i}).*$`);
                const p = l.toRegex(i, t);
                return !0 === o && (p.state = e), p;
              }),
              (l.makeRe = (e, t, n = !1, o = !1) => {
                ...
                return (
                  e.startsWith("./") &&
                    ((e = e.slice(2)), (p = i.prefix = "./")),
                  !1 === r.fastpaths ||
                    ("." !== e[0] && "*" !== e[0]) ||
                    (s = a.fastpaths(e, t)),
                  void 0 === s
                    ? ((i = a(e, t)), (i.prefix = p + (i.prefix || "")))
                    : (i.output = s),
                  l.compileRe(i, t, n, o)
                );
              }),
          ...
          615: (e, t, n) => {
            ...
            const o = n(761),
              r = (e, t, n) => {
                ...
                if (
                  ...
                  (g = s(u < 0 ? Math.abs(u) : 1, Math.abs(p), d, a)),
                    (p = d.a = 0);
                }
                return (
                  u >= 0 && (f = s(p, u, d, a)),
            ...
            function s(e, t, n, o) {
              let r,
                s = (function (e, t) {
                  let n = 1,
                    ...
                    r = u(e, n),
                    a = new Set([t]);
                  for (; e <= r && r <= t; ) a.add(r), (n += 1), (r = u(e, n));
              ...
              for (let e = 0; e < s.length; e++) {
                let t = s[e],
                  l = a(String(p), String(t), o),
                  u = "";
                n.isPadded || !r || r.pattern !== l.pattern
                  ? (n.isPadded && (u = g(t, n, o)),
                    (l.string = u + l.pattern + d(l.count)),
                    i.push(l),
                    (p = t + 1),
                    (r = l))
